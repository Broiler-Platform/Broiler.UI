...
/// <summary>
/// One row of the rich edit's context menu, as it stood when the menu
...
/// </param>
public readonly record struct StandardRichEditContextMenuItem(
    ...
    bool IsEnabled)
{
    ...
    public static StandardRichEditContextMenuItem Separator { get; } = new(null, string.Empty, string.Empty, false);
